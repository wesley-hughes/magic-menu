...
export const RecipeModal = ({ recipe, handleClose, visible }) => {
  ...
  return (
    ...
    <Link
      onClick={handleClose}
    >
      <img className="px-2 py-0 ml-5 h-8 hover:animate-spin" src="./images/close.png" alt="close"></img>
    </Link>
    <div className="grid grid-cols-2 w-[85%] items-center mx-auto justify-items-start">
      ...
      <div className="w-[80%] h-[300px] flex flex-col justify-between pb-10">
        <p className="text-purple-800 font-bold leading-tight tracking-tight drop-shadow-xl mb-2 text-3xl">{recipe?.title}</p>
