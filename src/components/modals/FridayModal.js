    ...
    <div className="fixed lg:inset-y-[0px] lg:pt-10 sm:inset-y-[160px] sm:mt-10 border border-purple-900 rounded-xl shadow-md drop-shadow-md p-1 bg-gray-50  backdrop-blur-sm overflow-y-auto scroll-smooth">
      ...
      <div className="flex flex-wrap justify-around items-center ">
          ...
          <img
            ...
            src={fridayRecipe?.image}
           alt="food"></img>
        
        <div className="mx-2">
          <p className="text-purple-800 font-bold leading-tight tracking-tight drop-shadow-xl text-3xl">{fridayRecipe?.title}</p>
        ...
        <article className="">
          ...
          <div className="lg:text-xl text-purple-800  lg:mx-10 leading-tight tracking-tight">{fridayRecipe.instructions}</div>
        </div>
      </div>
    </div>
